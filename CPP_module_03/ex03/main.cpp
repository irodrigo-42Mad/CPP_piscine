...
/*   Updated: 2022/10/25 14:26:23 by irodrigo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main (void)
{
	...
	std::cout << std::endl;
	std::cout << std::endl;
	std::cout << "Creating DiamondTrap elements" << std::endl;
	std::cout << "=============================" << std::endl;
	DiamondTrap dt1("krugger");
	DiamondTrap dt2("Beetlejuice");
	DiamondTrap dt3( dt2 );
	std::cout << std::endl;
	std::cout << "View DiamondTrap data: " << dt2.getName() << std::endl;
	std::cout << "AttackDamage: " << dt2.getAttackDamage() << std::endl;
	std::cout << "EnergyPoints: " << dt2.getEnergyPoints() << std::endl;
	std::cout << "HitPoints: " << dt2.getHitPoints() << std::endl;
	std::cout << std::endl;
	ct2.beRepaired(50);
	dt1.attack(ct2.getName());
	ct2.takeDamage(ft1.getHitPoints());
	ct2.attack(ft1.getName());
	ft1.takeDamage(ct2.getHitPoints());
	St1.attack(ft2.getName());
